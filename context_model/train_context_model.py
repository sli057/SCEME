...
def train(args=None):
	...
	parser.add_argument('--net_pretrained', help='the pretrained model', type=str,
						default='../output/faster_rcnn_end2end/voc_2007_trainval+voc_2012_trainval/VGGnet_wo_context/VGGnet_wo_context.ckpt')
	...
	parser.add_argument('--droprate', help='dropout rate for appearence features', type=float,
						default=0.2)
